...
public class DruidDSUtil {
    ...
    public static DruidDataSource createDataSource(){
        return getDruidDataSource(GmallConfig.PHOENIX_DRIVER,GmallConfig.PHOENIX_SERVER);
    }

    public static DruidDataSource getDruidDataSource(String driverClassName,String url){
        //创建连接池
